...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        // done (7) Use the flightInfo attribute in mBinding below to get the appropriate text Views
        ...
        // done (8) Use the boardingInfo attribute in mBinding below to get the appropriate text Views
